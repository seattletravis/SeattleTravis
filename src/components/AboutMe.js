    ...
    <div className={isSmall ? "aboutSmallScreen" : "about"}>
      ...
      <br></br>
        <p>
          <b>Update: Oct 2023</b>
          <br></br>
          I've obtained the Meta Front-End Developer Certificate. You can see my this certificate as well as my other awards on my linked in profile. 
        </p>
        <br></br>
        <p>
          <b>Objective:</b>
        ...
        <br></br>
        <p>
        While I was working at North Star, we had a computer fail on the spectrometer used to check the %alloys on the metal while it was in the furnace. We used this data to run a program that would tell the melters how much alloy was needed to add to the metal to correct the chemistry for the customer requested alloy. I was tasked with rebuilding the system to get it back up and running as soon as possible. The previous additions worksheets had a MS excel interface and had been very hard to use by the melters who had limited computer skills. I parsed the data from the excel and pulled it into a Python tkinter GUI so the melters could easily run the additions calculator and get the information they needed to get the needed metal chemistry for the customer. Doing this project in Python at North Star game me a can do attitude in programming, and I began to think that I too could become a software engineer. Not too later after that project the Covid-19 Pandemic hit. With Seattle's public places shut down for the better part of 2 years. I had more than enough personal time to spend working in python. So for years I ran the foundry in the day time (other managers worked from home as much as they could) and in the evenings, I wrote code, studied tutorials, and practiced new technologies. I decided that coding was what I wanted to pursue, and at one point subscribed to Udemy.com and started studying several more technologies. For some reason learning comes easy for me. Over time I became proficient in Visual Studio Code. I've become more confident in Linux, and have become familiar with docker containers, GitHub, and Scripting as well. I even log into HackerRank to earn badges and get certificates. As Seattle opens back up following the pandemic, it seems different but the same. Everything is moving quickly and I want to find a place to fit into the tech community.
        </p>
        <br></br>
        <p>
